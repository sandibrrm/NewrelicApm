...
#[derive(Debug)]
pub struct NewrelicApmProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NewrelicApmProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NewrelicApm processing");
    
    let mut processor = NewrelicApmProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NewrelicApmProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NewrelicApmProcessor::new(false);
